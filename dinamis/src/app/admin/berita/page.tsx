  ...
  return (
    <div>
      <div className="admin-page-header">
        <div>
          <div className="admin-page-title">Arsip Perkamen Lore</div>
          <div className="admin-page-subtitle">Kelola kisah, rumor, dan pengumuman dari The Forge ({berita.length} perkamen total)</div>
        </div>
        <Link href="/admin/berita/create" className="admin-btn admin-btn-primary">
          <PlusIcon /> Tulis Perkamen Baru
        </Link>
      </div>
            ...
            {berita.length === 0 ? (
              <tr>
                <td colSpan={5} style={{ textAlign: "center", padding: "48px", color: "#94a3b8" }}>
                  Belum ada perkamen. Klik &quot;Tulis Perkamen Baru&quot; untuk memulai.
                </td>
              </tr>
            ) : berita.map((item: any) => (
              <tr key={item.id}>
