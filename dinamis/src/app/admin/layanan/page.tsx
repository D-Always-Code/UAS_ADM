  ...
  return (
    <div>
      <div className="admin-page-header">
        <div>
          <div className="admin-page-title">Katalog Armory</div>
          <div className="admin-page-subtitle">Kelola koleksi senjata yang tersedia di The Forge ({layanan.length} senjata aktif)</div>
        </div>
        <Link href="/admin/layanan/create" className="admin-btn admin-btn-primary">
          <PlusIcon /> Tempa Senjata Baru
        </Link>
      </div>
        ...
        <table className="admin-table">
          <thead>
            <tr>
              ...
              <th>Nama Senjata</th>
              <th className="admin-col-hide-mobile">Deskripsi Material</th>
            ...
            {layanan.length === 0 ? (
              <tr>
                <td colSpan={5} style={{ textAlign: "center", padding: "48px", color: "#94a3b8" }}>
                  Belum ada senjata di Armory. Klik &quot;Tempa Senjata Baru&quot; untuk memulai.
                </td>
              </tr>
              ...
              <tr key={item.id}>
                ...
                <td>
                  <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px" }}>
                    ...
                    <DeleteButton
                      message="Hapus senjata ini dari Armory?"
                      action={async () => {
                        "use server";
